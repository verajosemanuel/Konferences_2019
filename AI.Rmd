...
---
background-image: url(media/nooorm.png)
background-position: 50% 50%
class: center, bottom

---

background-image: url(media/ww1-usa.jpg)
background-position: 50% 50%
class: center, bottom

test army α    /   test army β

---
background-image: url(media/war2.jpg)
background-position: 50% 50%
class: center, bottom



Álgebra matricial y analisis factorial = factor G, baterias de aptitud múltiple o pruebas diferenciales. Army Standard Scores: pilotos, artilleros, operadores de radio...
...
## Inteligencia Linguística
 ...
 - Análisis del sentimiento del discurso. Topic recognition
...
---
background-image: url(media/neuron-structure.png)
background-position: 50% 50%
class: center, bottom
...
---
background-image: url(media/judge.jpg)
background-position: 50% 50%
class: center, bottom
...
`Ética computacional y agentes morales artificiales`. Es un reto tecnológico necesario (coches autónomos). Es crítico desarrollar e implementar regulaciones morales aplicables a una IA para guiar su comportamiento.


---
background-image: url(media/economygrowth.jpg)
background-position: 50% 50%
class: center, bottom
